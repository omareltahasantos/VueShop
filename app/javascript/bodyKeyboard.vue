    ...
    <div class="row">
      <div class="col-lg-1 offset-lg-1">
        <ul class="lista pl-0">
          ...
          <li>
            <a v-bind:href="link.keycap" class="lista-item" v-if="mainPage==='Keycaps'" v-bind:style="{color:activePage}">Keycaps</a>
      ...
      <div class="col-lg-7 offset-lg-2 pt-5">
        ...
        <div class="row">
          <div class="col-lg-4 " v-for="keyboard in keyboardsArray" v-bind:key="keyboard">
            <div class="row">
              <div class="col-lg-12">
                <a v-bind:href="'/keyboards/'+keyboard.id"><img class="img-fluid colImage" v-bind:style="styleImages" :src="keyboard.image"></a>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12 pt-2">
                  <p style="text-align:center" v-if="keyboard.status==='SOLD OUT'" v-bind:style="{color:activePage}" >AGOTADO</p>
                  <p style="text-align:center" v-else>EN STOCK</p>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12 pt-0">
                <a class="colTitle nav-item nav-link" v-bind:href="'/keyboards/'+keyboard.id">{{keyboard.name}}</a>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12 pt-0 justify-content-center">
                  <p style="text-align:center">{{keyboard.price}}EUR</p>
...
export default {
    ...
    computed: {
     ...
     created () {
        axios
        .get('/keyboards.json')
        .then(response => (this.keyboardsArray = response.data))
    }
}
</script>
